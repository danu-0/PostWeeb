...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $products->update($id, $nama, $harga, $deskripsi, $kategori, $stok);
    if ($result) {
        header('Location: index.php');
    } else {
        // error, pesan, validasi
    }
    // cek simpan -> true (index.php), false (error)
}
?>
...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?id=" . $id ?>">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <button class="btn text-white primary" type="submit">Simpan Product</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/sweetalert2@11.12.0/dist/sweetalert2.all.min.js"></script>
